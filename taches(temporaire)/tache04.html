...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
    ...
    <body>
        <!-- ********* DEBUT HEADER ********* -->
        <header>
            <?php include("./../views/view_menu1.html"); ?>
        </header>
        <!-- ********* FIN HEADER ********* -->

        <!-- ********* DEBUT CONTENU PRINCIPAL ********* -->
        <div class="container">
        <h3> Vidéo de présentation du jeu par l'avatar </h3>

        <!--
        <video class="responsive-video" controls>
            <source src="./../medias/roxianim2.mp4" type="video/mp4">
        </video>
         -->

        <a href="tache05.php">Passer l'introduction </a>
        </div>
